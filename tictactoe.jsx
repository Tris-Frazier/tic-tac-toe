...
const Square = ({ takeTurn, id }) => {
  const mark = ["./img/unicorn.jpg", "./img/tiger.jpg", null];
  ...
  return (
    ...
    >
      {mark === null ? (
        ...
        <img src={mark[tik]} alt="" className="small-img" />
      )}
    </button>
  );
};
...
const checkForWinner = (gameState) => {
  ...
  if (win0.length > 0) return "Unicorn";
  else if (winX.length > 0) return "Tiger";
